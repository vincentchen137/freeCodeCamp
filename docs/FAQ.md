...
freeCodeCamp runs on a modern Javascript stack. If you're interested in contributing to our codebase, you would only need to know Javascript and familiary with the technologies we use like Node.js, MongoDB, OAuth 2.0, React, Gatsby, and Webpack. 
...
To make educational videos for our YouTube channel, you can follow the [YouTube channel guide here](https://www.freecodecamp.org/news/how-to-contribute-to-the-freecodecamp-community-youtube-channel-b86bce4c865/).
